package cn.itcast.netty.T04_event_loop_group;
...
/**
 * @author zhanglin
 * @description eventLoopGroup配置使用用例
 */
@Slf4j
public class EventLoopClient {
    public static void main(String[] args) throws InterruptedException {
        ...
        channelFuture.addListener((ChannelFutureListener) future -> {
            ...
            // channel关闭并通知监听器关闭channel
            channel.close();
        });

        // 优雅关闭
        channelFuture.sync().channel().closeFuture().addListener((ChannelFutureListener) future -> {
